...
def generator_simplified_api(inputs, is_train=True, reuse=False):
    ...
    with tf.variable_scope("generator", reuse=reuse):
        ...
        net_h0 = BatchNormLayer(net_h0, act=leaky_relu, is_train=is_train,
        ...
        net_h1 = BatchNormLayer(net_h1, act=leaky_relu, is_train=is_train,
        ...
        net_h2 = BatchNormLayer(net_h2, act=leaky_relu, is_train=is_train,
        ...
        net_h3 = BatchNormLayer(net_h3, act=leaky_relu, is_train=is_train,
